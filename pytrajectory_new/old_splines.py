...
class CubicSpline(object):
    ...
    def __init__(self, a=0.0, b=1.0, n=5, tag='', bc=[None, None], bcd=[None, None], bcdd=[None, None], steady=False):
        self.a = a
        self.b = b
        self.n = int(n)
        self.tag = tag
        ...
        self._prov_S = np.ones_like(self._coeffs)
        self._prov_S_abs = np.zeros((self.n,4))
    ...
    def makesteady(self):
        ...
        tmp_coeffs = np.zeros_like(self._coeffs, dtype=None)
        ...
        self._prov_S = tmp_coeffs
        self._prov_S_abs = tmp_coeffs_abs

        # docu p. 13: a is vector of independent spline coeffs (free parameters)
        self._indep_coeffs = a
