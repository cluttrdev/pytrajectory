...
version = pytrajectory.__version__ #'1.0.0'
# The full version, including alpha/beta/rc tags.
#release = pytrajectory.__release__ #'1.0.0'
release = pytrajectory.__version__ #'1.0.0'
...
htmlhelp_basename = 'pytrajectorydoc'
...
latex_documents = [
  ('index', 'pytrajectory.tex', u'pytrajectory Documentation',
   u'Andreas Kunze', 'manual'),
]
...
man_pages = [
    ('index', 'pytrajectory', u'pytrajectory Documentation',
     [u'Andreas Kunze'], 1)
]
...
texinfo_documents = [
  ('index', 'pytrajectory', u'pytrajectory Documentation',
   u'Andreas Kunze', 'pytrajectory', 'One line description of project.',
   'Miscellaneous'),
]
